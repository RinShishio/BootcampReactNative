...
var thirfWordLength = thirdWord3.length
var fourthWordLength = fourthWord3.length
var fifthWordLength = fifthWord3.length

console.log("String no 4")
console.log('First Word: ' + exampleFirstWord3 + ', with length: ' + firstWordLength); 
console.log('Second Word: ' + secondWord3 + ', with length: ' + secondWordLength); 
console.log('Third Word: ' + thirdWord3 + ', with length: ' + thirfWordLength); 
...
if (hari <= 31 && hari >= 1 && tahun >=1900 && tahun <= 2200) {
    switch(bulan) {
        ...
        case 9:   { console.log(hari+' Sebtember '+ tahun); break; }
